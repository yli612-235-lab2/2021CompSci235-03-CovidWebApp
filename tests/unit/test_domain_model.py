...
from covid.domain.model import Publisher, Author, Book, Review, User, BooksInventory
from covid.adapters.jsondatareader import BooksJSONReader
...
def read_books_and_authors():
    ...
    data_folder = Path("covid/adapters/data")
